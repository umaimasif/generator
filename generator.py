...
#---API KEY---
load_dotenv(dotenv_path="C:/Users/hp/Desktop/streamlit/.env")
google_api_key = os.getenv("GOOGLE_API_KEY")
if not google_api_key:
    raise ValueError("GOOGLE_API_KEY not loaded. Check your .env file.")
...
def generate_lullaby(location, name, language):
    ...
    chain_story = LLMChain(llm=gemini_llm, prompt=prompt, 
                        output_key="story",
                        verbose=True)
